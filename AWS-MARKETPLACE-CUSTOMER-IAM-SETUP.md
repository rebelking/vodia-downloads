...
The MCP-side AWS work is installed and active. The Marketplace in-chat purchase flow is added in **v0.14.9.27**.

- Vodia MCP version target: `0.14.9.27`
...
- v0.14.9.27 can create a live AWS quote in chat and accept it only after explicit customer confirmation; it does not silently purchase.
