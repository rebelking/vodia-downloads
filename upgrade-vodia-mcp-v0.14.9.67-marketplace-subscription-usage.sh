...
# Make subscription check pass the enriched response into the renderer.
...
if old not in s:
    raise SystemExit("PATCH ERROR: checkMarketplaceSubscription render anchor missing")
s=s.replace(old,new,1)
...
echo "5. The agreement used by Hamlet1 should show IN USE and instance i-05b201c2bda680fc2."
