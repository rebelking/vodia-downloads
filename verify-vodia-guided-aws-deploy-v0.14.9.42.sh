...
checks={
  "v0.14.9.42 UI URI": 'ui://vodia/msp-guided/v0.14.9.42/mcp-app.html' in module,
  ...
  "UI app version": 'appInfo:{name:"vodia-setup",version:"1.8.4"}' in ui,
}
...
echo
echo "RESULT: PASS — guided AWS onboarding, region-aware instance selection, planning, and approval-gated deployment are present."
